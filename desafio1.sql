...
INSERT INTO SpotifyClone.users (user_name, user_age, plan_id, sub_date)
VALUES
...
INSERT INTO SpotifyClone.songs (song_name, album_id, artist_id, duration_sec)
VALUES
  ("Soul For Us", 1, 2, 200),
  ("Reflections Of Magic", 1, 2, 163),
  ("Dance With Her Own", 1, 2, 116),
  ("Troubles Of My Inner Fire", 2, 2, 203),
  ("Time Fireworks", 2, 2, 152),
  ("Magic Circus", 3, 3, 105),
  ("Honey, So Do I", 3, 3, 207),
  ("Sweetie, Let's Go Wild", 3, 3, 139),
  ("She Knows", 3, 3, 244),
  ("Fantasy For Me", 4, 1, 100),
  ("Celebration Of More", 4, 1, 146),
  ("Rock His Everything", 4, 1, 223),
  ("Home Forever", 4, 1, 231),
  ("Diamond Power", 4, 1, 241),
  ("Let's Be Silly", 4, 1, 132),
...
VALUES
  ...
  (1, 20, '2017-02-06 08:21:34'),
  (1, 21, '2017-12-04 05:33:43'),
  (1, 12, '2017-07-27 05:24:49'),
  (1, 13, '2017-12-25 01:03:57');